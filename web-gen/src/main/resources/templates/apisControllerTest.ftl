...
@DirtiesContext
@ActiveProfiles({ PROFILES.APIS, PROFILES.JUNIT, PROFILES.DEV })
public class Apis${className}ControllerTests {
	...
	public void list() throws Exception {
		String url = "http://localhost:" + this.port + CTL.APIS_PATH + "/${tableUrl}/list";
	...
	public void save() throws Exception {
		...
		map.set("id", "root");
		String url = "http://localhost:" + this.port + CTL.APIS_PATH + "/${tableUrl}/save";
