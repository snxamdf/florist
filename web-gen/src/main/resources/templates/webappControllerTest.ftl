...
@DirtiesContext
@ActiveProfiles({ PROFILES.WEBAPP, PROFILES.JUNIT, PROFILES.DEV })
public class Webapp${className}ControllerTests {
	...
	public void list() throws Exception {
		String url = "http://localhost:" + this.port + CTL.WEBAPP_PATH + "/${tableUrl}/list";
	...
	public void save() throws Exception {
		...
		map.set("id", "root");
		String url = "http://localhost:" + this.port + CTL.WEBAPP_PATH + "/${tableUrl}/save";
