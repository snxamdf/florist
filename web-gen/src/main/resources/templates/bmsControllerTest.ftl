...
public class Bms${className}ControllerTests {
	...
	public void list() throws Exception {
		String url = "http://localhost:" + this.port + CTL.BMS_PATH + "/${tableUrl}/list";
	...
	public void save() throws Exception {
		...
		map.set("id", "root");
		String url = "http://localhost:" + this.port + CTL.BMS_PATH + "/${tableUrl}/save";
