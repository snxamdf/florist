...
public class JsonMapper {
	 ...
	 * 输出JSONP格式数据.
	 */
	public String toJsonP(String functionName, String key, String value) {
		Map<String, Object> map = Maps.newHashMap();
		map.put(key, value);
		return toJson(new JSONPObject(functionName, map));
	}
