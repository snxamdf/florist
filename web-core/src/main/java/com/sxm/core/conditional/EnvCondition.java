 ...
 * 
 */
package com.sxm.core.conditional;
...
public class EnvCondition implements Condition {
	...
	public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
		boolean isBmsEnv = metadata.isAnnotated("com.sxm.core.annotation.BmsEnv");
		boolean isWebEnv = metadata.isAnnotated("com.sxm.core.annotation.WebEnv");
		boolean isWebappEnv = metadata.isAnnotated("com.sxm.core.annotation.WebappEnv");
		boolean isApisEnv = metadata.isAnnotated("com.sxm.core.annotation.ApisEnv");
