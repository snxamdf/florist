...
public class BmsFloristLeaveMsgControllerTests {
	...
	public void list() throws Exception {
		String url = "http://localhost:" + this.port + CTL.BMS_PATH + "/florist/leave/msg/list";
		ResponseEntity<String> entity = new TestRestTemplate().getForEntity(url, String.class);
		assertEquals(HttpStatus.OK, entity.getStatusCode());
		assertTrue("Wrong body (title doesn't match):\n" + entity.getBody(), entity.getBody().contains("<title>留言版"));
	...
	public void save() throws Exception {
		...
		map.set("id", "root");
		String url = "http://localhost:" + this.port + CTL.BMS_PATH + "/florist/leave/msg/save";
