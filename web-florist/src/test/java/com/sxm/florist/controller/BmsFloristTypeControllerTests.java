...
public class BmsFloristTypeControllerTests {
	...
	public void list() throws Exception {
		String url = "http://localhost:" + this.port + CTL.BMS_PATH + "/florist/type/list";
		ResponseEntity<String> entity = new TestRestTemplate().getForEntity(url, String.class);
		assertEquals(HttpStatus.OK, entity.getStatusCode());
		assertTrue("Wrong body (title doesn't match):\n" + entity.getBody(), entity.getBody().contains("<title>鲜花类型"));
	...
	public void save() throws Exception {
		...
		map.set("id", "root");
		String url = "http://localhost:" + this.port + CTL.BMS_PATH + "/florist/type/save";
