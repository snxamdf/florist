...
@WebEnv
@Controller
@RequestMapping(value = CTL.WEB_PATH + "/florist/type")
public class WebFloristTypeController extends BaseController<FloristType, String> {

	@SuppressWarnings("unused")
	private static Logger logger = LoggerFactory.getLogger(WebFloristTypeController.class);
	...
	public Module<FloristType> getModule() {
		return new Module<FloristType>(FLORIST.PROJECT, "florist.type", CTL.WEB, FloristType.class);
	}
